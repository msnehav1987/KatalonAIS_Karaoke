...
Mobile.tap(findTestObject('Karaoke/Category/Playlist/Play button'), 0)

Mobile.verifyElementText(findTestObject('Karaoke/Category/Playlist/keun tee daw tem fha Text'), 'คืนที่ดาวเต็มฟ้า')

Mobile.tap(findTestObject('Karaoke/Category/Delete all/Delete all button'), 0)

Mobile.tap(findTestObject('Karaoke/Category/Delete all/Yes button'), 0)

Mobile.verifyElementText(findTestObject('Karaoke/Category/Delete all/No queue Text'), 'ไม่มีคิวเพลง')

...
Mobile.tap(findTestObject('Karaoke/Setting/Login/Setting Login'), 0)

Mobile.verifyElementText(findTestObject('Karaoke/Setting/Login/Setting Login Text'), ' ล็อกอิน')

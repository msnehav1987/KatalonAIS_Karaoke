...
Mobile.tap(findTestObject('Karaoke/Search/Search Hit/Chat suchat Layout'), 0)

Mobile.verifyElementText(findTestObject('Karaoke/Search/Search Hit/Chat suchat Text'), 'ชาติ สุชาติ')
